...
export const translations = {
  en: {
    ...
    signInNow: "Sign in",
    authWelcome: "Welcome back, traveler.",
    authBeginJourney: "Begin your journey today.",
  ...
  es: {
    ...
    expenses: "Gastos",
    missionNotes: "Atracciones",
    noData: "// SIN DATOS DISPONIBLES",
    regenVisual: "Regenerar Visual",
    generating: "Generando...",
    editImage: "Editar Imagen",
    uploadImage: "Subir Imagen",
    deleteMission: "Eliminar",
    visualDiary: "Bitácora",
    ...
    authWelcome: "Bienvenido de vuelta, viajero.",
    authBeginJourney: "Comenzá tu viaje hoy.",
